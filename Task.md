...
### Sự khác nhau giữa HTTP và HTTPS 
    ...
    + Ngoài ra web sử dụng giao thức Https là tín hiệu để Google xếp hạng từ khóa. Việc này khiến rất nhiều trang Web chuyển qua dùng giao thức Https để Seo được tốt hơn.
